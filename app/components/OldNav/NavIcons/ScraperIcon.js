...
export default function ScraperIcon(props) {
  return (
    <svg className="tnm-nav-icon" version="1.1" x="0px" y="0px" viewBox="0 0 72 72" enableBackground="new 0 0 72 72" xmlSpace="preserve">
